...
switch($_GET[act]){
  ...
  //TAMBAH//////////////////////////
   ...
   <input type=file name='fupload' size=40> *Gambar harus landscape berukuran sekitar 550x309
   </p> 	
  ...
  <textarea name='keterangan' style='width: 720px; height: 200px;'>$r[keterangan]</textarea>
   ...
   <input type=file name='fupload' size=30> *Gambar harus landscape berukuran sekitar 550x309
   </p>		  
