...
switch($_GET[act]){
 ...
 <img src='images/icn_trash.png' title='Hapus'></a>		        </tr>";
  ...
  <input type=text name='sub_judul' size=60>
   ...
   <input type=file name='fupload' size=40> *Gambar harus landscape berukuran sekitar 450x250
   </p> 	  
  ...
  <input type=text name='sub_judul' size=60 value='$r[sub_judul]'>
   ...
   <label for=field4>Gambar</label> ";
   if ($r[gambar]!=''){
   echo "<img src='../img/foto_berita/small_$r[gambar]'>
   </p>";} 	  
   ...
   <input type=file name='fupload' size=30> *Gambar harus landscape berukuran sekitar 450x250
   </p> 	  
   ...
   <li>
	...
	case "repairimage":
	repair_image_size('gambar','berita','../img/foto_berita/','450','225');
