<?php
session_start();
$image_path = "../../../img/logo/zal_marking.png";
$font_path = "RIZAL.TTF";
...
if ($module=='berita' AND $act=='hapus'){
  ...
  if ($data['gambar']!=''){
     ...
     unlink("../../../img/foto_berita/$_GET[namafile]");   
     unlink("../../../img/foto_berita/small_$_GET[namafile]");   
  }
  else{
     mysqli_query($conn, "DELETE FROM berita WHERE id_berita='$_GET[id]'");
  }
...
elseif ($module=='berita' AND $act=='input'){
  ...
  if (!empty($lokasi_file)){
    ...
    watermark_image('../../../img/foto_berita/'.$nama_file_unik);
...
elseif ($module=='berita' AND $act=='update'){
  ...
  header('location:../../media.php?module='.$module);
	...
	@unlink('../../../img/foto_berita/'.$r['gambar']);
	@unlink('../../../img/foto_berita/'.'small_'.$r['gambar']);
    UploadImage($nama_file_unik,'../../../img/foto_berita/',300,120);
	watermark_image('../../../img/foto_berita/'.$nama_file_unik);
