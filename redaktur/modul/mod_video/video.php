...
switch($_GET[act]){
  ...
  <input type=text name='jdl_video' size=60>
   ...
   <input type=file name='fupload2' size=40> *Gambar harus landscape berukuran sekitar 400x303 <br/>
  ...
  <input type=text name='jdl_video' size=60 value='$r[jdl_video]'>
   ...
   <textarea name='keterangan' style='width:720px; height: 250px;'>$r[keterangan]</textarea>
    ...
    <label for=field4>Gambar</label> ";
    if ($r[gbr_video]!=''){
    echo "<img src='../img/img_video/kecil_$r[gbr_video]'> </p>"; }
  	 
    echo "
	
    <p class=inline-small-label> 
    <label for=field4>Ganti Gambar</label>
    <input type=file name='fupload' size=30> *Gambar harus landscape berukuran sekitar 400x303
    </p> 
   ...
   <label for=field4>Video Terpasang: </label>";
    ...
    echo "<div style='background-image:url(../img/img_video/kecil_$r[gbr_video]); 
