...
$perHalaman=6;
  ...
  $dt = ambilData('berita', 'kategori', 'id_kategori', 'nama_kategori', 'Renungan', 'id_berita', $hal, $perHalaman);
    foreach ($dt as $row) {
      $b = $row['id_berita'];
...
<?php
  echo tampilHalaman('berita', $perHalaman, 'renungan', 'kategori', 'id_kategori', 'nama_kategori', 'Renungan', 'id_berita');
?>
