...
$perHalaman=6;
  ...
  $dt = ambilData('berita', 'kategori', 'id_kategori', 'nama_kategori', 'Ekonomi', 'id_berita', $hal, $perHalaman);
    foreach ($dt as $row) {
     $b = $row['id_berita'];
...
<?php
  echo tampilHalaman('berita', $perHalaman, 'ekonomi', 'kategori', 'id_kategori', 'nama_kategori', 'Ekonomi', 'id_berita');
?>
