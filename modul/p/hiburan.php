...
$perHalaman=6;
  ...
  $dt = ambilData('berita', 'kategori', 'id_kategori', 'nama_kategori', 'Hiburan', 'id_berita', $hal, $perHalaman);
    foreach ($dt as $row) {
      $b = $row['id_berita'];
...
<?php
  echo tampilHalaman('berita', $perHalaman, 'hiburan', 'kategori', 'id_kategori', 'nama_kategori', 'Hiburan', 'id_berita');
?>
