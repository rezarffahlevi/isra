...
<?php
  ...
  while($row=$sql->fetch_array())
    { ?>
            <div class="sec-topic col-sm-16 col-md-8 wow fadeInDown animated" data-wow-delay="0.5s"> <a href="?detail_berita=<?php echo $row['id_berita']; ?>"><img width="1000" height="606" alt="" src="<?php echo "img/foto_berita/".$row['gambar']; ?>" class="img-thumbnail">
              <div class="sec-info">
